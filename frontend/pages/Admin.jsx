...
const LogInPage = ({ onSuccess }) => {
  ...
  return (
    <div className="admin-lock bg-gray-50 dark:bg-gray-900 flex items-center justify-center h-[calc(100vh-4rem)] flex-col">
      <div className="flex items-center justify-center w-full">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 p-6 w-full max-w-md">
          {/* Lock Icon */}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <input
                ...
                required
                className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
...
const AdminPage = ({ onLogOut }) => {
  ...
  return (
    <div className="space-y-6 bg-[#101827] px-20 py-20">
      ...
      {/* addtion form that will triger when press add item*/}
      {showAddForm && (
      ...
      {/* display all the items in a well formated table*/}
      {items && (
                        ...
                        <>
                          <td className="px-3 lg:px-6 py-4 text-sm text-slate-900 dark:text-slate-200 text-left">
                            <input
                              ...
                              name="item_name"
                              value={
                                updatedItems.item_name ?? item.item_name ?? ""
                              }
                              onChange={(e) => {
